...
public class Correo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String correo_receptor = txt_correo.getText();
        String asunto = "Programacion en Java";
        String mensaje = "Hola <br> <b>estoy Practicando en Java</b><br><i>Tengo 14 años  </i><br>Suscríbete al canal de la Tecnologia Avanza . ";
        ...
        adjuntos.setDataHandler(new DataHandler(new FileDataSource("D:\\Imagen.jpg"))); //Aqui pones la direccion de tu imagen
